...
knowledge belongs in the [app spec](../spec/app.md), the
...
App milestones depend on them.

## Contents

| File | Purpose |
|---|---|
| [milestones.md](milestones.md) | App milestones in order, with their scope and exit criteria |
